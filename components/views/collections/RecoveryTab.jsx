      ...
      <DataTable
        ...
        renderRow={(r) => (
          <tr key={r.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors whitespace-nowrap">
            ...
            <td className="px-5 py-3 text-[13px] font-medium text-body">{r.member}</td>
            ...
            <td className="px-5 py-3">
              <span className={`text-[11px] font-semibold px-2.5 py-0.5 rounded-full border whitespace-nowrap ${
                r.stage === "Legal" ? "bg-danger-50 text-danger-500 border-danger-200/60"
                : r.stage === "Field Visit" ? "bg-orange-50 text-orange-600 border-orange-200/60"
                : r.stage === "Follow-up" ? "bg-warning-50 text-warning border-warning-200/60"
                : r.stage === "Notice Sent" ? "bg-blue-50 text-blue-600 border-blue-200/60"
                : r.stage === "Settled" ? "bg-success-50 text-success border-success-200/60"
            ...
            <td className="px-5 py-3 text-[11px] text-heading max-w-[200px]">{r.lastAction}</td>
