...
export default function FloatingAIButton({ onClick }) {
  ...
  return (
    <button
      ...
      className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50 w-14 h-14 bg-gradient-to-br from-[#27c08d] to-secondary rounded-full flex items-center justify-center shadow-lg shadow-primary-500/30 hover:shadow-primary-500/50 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer group"
    >
      ...
      {/* Pulse ring */}
      <span className="absolute inset-0 rounded-full bg-primary-400/20 animate-ping pointer-events-none" style={{ animationDuration: "3s" }} />
