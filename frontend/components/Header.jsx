...
export default function Header({ pageTitle, onNavigateProfile, onNavigateHelpCenter }) {
              ...
              <div className="max-h-80 overflow-y-auto">
                {activeNotifs.length === 0 ? (
                  <div className="px-4 py-10 flex flex-col items-center justify-center gap-2">
                    <svg className="w-10 h-10" style={{ color: darkMode ? "#334155" : "#cbd5e1" }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
                    </svg>
                    <p className="text-sm font-medium" style={{ color: darkMode ? "#94a3b8" : "#64748b" }}>No notifications found</p>
                    <p className="text-[11px]" style={{ color: darkMode ? "#475569" : "#94a3b8" }}>You're all caught up!</p>
                  </div>
                ) : (
            ...
            >
              ...
              <div className="py-1.5">
                {[
                  ...
                  { label: "Help Center", onClick: () => { setShowProfileMenu(false); onNavigateHelpCenter?.(); }, icon: "M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z" },
                ].map((item) => (
                  <button
                    key={item.label}
