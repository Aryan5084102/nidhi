    ...
    <div className="fixed inset-0 z-50 bg-white overflow-y-auto">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-slate-100 px-4 sm:px-6 py-3">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <button onClick={onClose} className="w-9 h-9 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-heading hover:text-body hover:bg-slate-100 cursor-pointer transition-all">
      ...
      {submitted ? (
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          ...
          <button onClick={onClose} className="w-full max-w-sm py-3 bg-primary text-white rounded-xl text-[13px] font-semibold hover:bg-primary-700 transition-all cursor-pointer">
