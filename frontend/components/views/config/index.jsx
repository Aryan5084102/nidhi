  ...
  return (
    <div className="animate-fade-in">
      <PageHeader
        ...
        description="System-wide settings for Glimmora Nidhi operations. Configure deposit schemes, loan parameters, chit fund rules, AI agent behaviour, and notification preferences. All settings are audited and comply with Chit Funds Act 1982 and Nidhi Company regulatory requirements."
      >
